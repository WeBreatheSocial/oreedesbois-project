...
const access = () => {
    return (
        <div className="bg-access mx-auto px-4 sm:px-6 py-2" id='access'>
            ...
            <span className='block text-center lg:text-left'><Image src={Pin} alt=''/> </span>
            ...
            <p className='section-p my-5'>Orée des Bois, un projet de Koutoubia li Taamir qui s’engage à vous proposer les meilleurs lots de villa à proximité de toutes commodités : </p>
            <div className='access-options'> 
            <ul className='w-full lg:w-1/2 lg:mx-0 mx-auto px-6 lg:px-0 '>
            <li> Commerces </li>
           ...
           <iframe className='w-full' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3328.4678777840927!2d-7.667126684473704!3d33.463167480770366!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzPCsDI3JzQ3LjQiTiA3wrAzOSc1My44Ilc!5e0!3m2!1sen!2sma!4v1635870322742!5m2!1sen!2sma" height="450" frameborder="0"  allowfullscreen="" aria-hidden="false" tabindex="0" loading="lazy"></iframe>
             </div>
            </div>
            </div>
        </div>
