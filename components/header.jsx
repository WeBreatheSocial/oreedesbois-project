      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center border-b-2 border-gray-100 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <Link href="/" alt=''>
                <Image src={Logo} alt='' width={200}  className='cursor-pointer'/>
            </Link>
          </div>
...
<svg xmlns="http://www.w3.org/2000/svg" height="28px" width="28px" viewBox="-461 463 36 36"><path d="M-461 463h36v36h-36v-36z" fill="none"/><path d="M-432.5 481h3c0-7.5-6-13.5-13.5-13.5v3c5.8 0 10.5 4.7 10.5 10.5zm-6 0h3c0-4.1-3.4-7.5-7.5-7.5v3c2.5 0 4.5 2 4.5 4.5zm-2.7 8.1c-4.2-2.2-7.7-5.6-9.9-9.9l3.8-3.8-.9-7.9h-8.3c-.9 15.3 11.7 27.8 27 27v-8.3l-7.9-.9-3.8 3.8z" fill="#c93"/>
                ...
                <div className='self-start relative'>
                 <Link href="/" alt=''>
                <Image src={Logo} alt='' width={250}  className='cursor-pointer logo-mobile'/>
            </Link>
            </div>
                <div className=''>                  <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-black hover:btn-color hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
<svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="30px" width="30px" xmlns="http://www.w3.org/2000/svg"><path d="M64 384h384v-42.666H64V384zm0-106.666h384v-42.667H64v42.667zM64 128v42.665h384V128H64z"></path></svg>
                  </Popover.Button>
                   </div>
            </div>
