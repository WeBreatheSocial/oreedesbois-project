...
const contact = () => {
    return (
        ...
        <div className="mx-auto px-4 sm:px-6 py-2 bg-white">
            ...
            <span className='block text-center '><Image src={Contact} alt='' width='50px'/> </span> 
            ...
            <h4 className='section-subtitle my-5 text-center uppercase'>Nous reviendrons vers vous au plus vite.</h4>
            </div>
          <Form />
            </div>
        </div>
