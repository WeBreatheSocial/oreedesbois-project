...
<label className="checkbox"> 
    ...
    <span className="checkbox-checkmark-box">
      ...
      <span className=' max-w-4xl text-sm cursor-default font-normal'> Je déclare avoir lu les conditions générales d’utilisation, notamment la mention relative à la protection des données personnelles.
    </span>
</span>
    </label>
    </div>
